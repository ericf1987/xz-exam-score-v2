...
public class ScannerDBServiceTest extends XzExamScoreV2ApplicationTests {
    ...
    public void testCalculateScore() throws Exception {
        assertEquals(1, calculateScore(1, "A,D", "AD", false).score, 0.1);
        assertEquals(1, calculateScore(1, "A,D", "DA", false).score, 0.1);
        assertEquals(0, calculateScore(1, "A,D", "", false).score, 0.1);
