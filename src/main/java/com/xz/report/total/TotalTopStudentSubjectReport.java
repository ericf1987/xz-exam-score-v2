...
public class TotalTopStudentSubjectReport extends ReportGenerator{
    ...
    protected List<SheetTask> getSheetTasks(String projectId, Range range) {
        ...
        SheetTask projectTask = new SheetTask("全部科目", TotalTopStudentSubjectSheets.class);
        ...
        for (Target subject : subjects) {
            ...
            projectTask = new SheetTask(subjectName, TotalTopStudentSubjectSheets.class);
