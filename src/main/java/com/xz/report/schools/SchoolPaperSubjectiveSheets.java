...
import com.xz.api.server.school.SchoolSubjectiveAnalysis;
...
public class SchoolPaperSubjectiveSheets extends SheetGenerator {
    ...
    private void setupSecondaryHeader(ExcelWriter excelWriter, List<Map<String, Object>> classes) {
        ...
        for (int i = 0; i < classes.size(); i++) {
            excelWriter.set(0, column.incrementAndGet(), SECONDARY_COLUMN[0]);
            excelWriter.set(0, column.incrementAndGet(), SECONDARY_COLUMN[1]);
        }
    }

    private void fillData(ExcelWriter excelWriter, Object classes) {
        //// TODO: 2016/6/19
    }
}
