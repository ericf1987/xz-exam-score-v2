...
public class Config {
    ...
    @Value("${scanner.db.addr.g10}")
    private String scannerMongoAddr_g10;
    ...
    @Bean
    public MongoClient scannerMongoClient_g10() throws Exception {
        List<ServerAddress> seeds = readServerAddress(scannerMongoAddr_g10);
        MongoClientOptions options = MongoClientOptions.builder().build();  // 缺省连接池大小为100
        return new MongoClient(seeds, options);
    }
