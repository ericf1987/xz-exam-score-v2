...
@Component
@AggrTaskMeta(taskType = "total_score_school")
public class TotalScoreSchoolTask extends AggrTask {
    @Autowired
    ...
    protected void runTask(AggrTaskMessage taskInfo) {
        TotalScoreClassTask.aggrFromTotalScore(
                taskInfo, scoreDatabase, scoreService, rangeService, Range.CLASS, Range.SCHOOL);
    }
}
