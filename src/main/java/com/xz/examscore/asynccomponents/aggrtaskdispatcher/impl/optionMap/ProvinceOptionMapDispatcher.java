 ...
 */
@Component
@TaskDispatcherInfo(taskType = "province_option_map", dependentTaskType = "school_option_map")
public class ProvinceOptionMapDispatcher extends TaskDispatcher {
    static final Logger LOG = LoggerFactory.getLogger(ProvinceOptionMapDispatcher.class);
    ...
    public void dispatch(String projectId, String aggregationId, ProjectConfig projectConfig, Map<String, List<Range>> rangesMap) {
        ...
        LOG.info("最终为项目 " + projectId + " 的 province_option_map 统计发布了 " + counter + " 个任务");
    }
}
