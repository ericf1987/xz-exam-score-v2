...
@Component
public class SchoolBasicRankReport extends ReportGenerator{
    @Autowired
    ...
    protected List<SheetTask> getSheetTasks(String projectId, Range range) {
        ...
        SheetTask projectTask = new SheetTask("全部科目", SchoolBasicRankSheet.class);
        ...
        for (Target subject : subjects) {
            ...
            projectTask = new SheetTask(subjectName, SchoolBasicRankSheet.class);
