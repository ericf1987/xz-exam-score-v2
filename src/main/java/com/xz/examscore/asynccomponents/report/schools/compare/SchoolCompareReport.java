 ...
 * 学校成绩分析-历次考试对比-历史考试数据对比
 */
@Component
public class SchoolCompareReport extends ReportGenerator {
    ...
    protected List<SheetTask> getSheetTasks(String projectId, Range range) {
        ...
        SheetTask projectTask = new SheetTask("全部科目", SchoolCompareSheets.class);
        ...
        for (Target subject : subjects) {
            ...
            projectTask = new SheetTask(subjectName, SchoolCompareSheets.class);
