...
import com.xz.examscore.api.server.project.ProjectAbilityLevelAnalysis;
 ...
 */
@Component
public class TotalAbilityLevelSheets extends SheetGenerator {
    ...
    private void fillSchoolData(ExcelWriter excelWriter, Result result) {
        ...
        for(Map<String, Object> school : schools){
            List<Map<String, Object>> pointStats = (List<Map<String, Object>>)school.get("levelStats");
