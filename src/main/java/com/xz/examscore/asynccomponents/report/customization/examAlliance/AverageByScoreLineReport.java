...
import com.xz.examscore.asynccomponents.report.schools.SchoolPaperHScoreSheets;
...
@Component
public class AverageByScoreLineReport extends ReportGenerator{
    ...
    protected List<SheetTask> getSheetTasks(String projectId, Range range) {
        ...
        SheetTask projectTask = new SheetTask("全部科目", AverageByScoreLineSheets.class);
