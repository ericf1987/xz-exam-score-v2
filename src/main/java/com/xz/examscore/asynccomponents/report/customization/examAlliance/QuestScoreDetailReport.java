...
import com.xz.examscore.asynccomponents.report.schools.SchoolBasicRankSheet;
...
@Component
public class QuestScoreDetailReport extends ReportGenerator{
    ...
    protected List<SheetTask> getSheetTasks(String projectId, Range range) {
        ...
        for (Target subject : subjects) {
            ...
            SheetTask projectTask = new SheetTask(subjectName, QuestScoreDetailSheets.class);
