 ...
 */
@Component
public class SchoolPassCompareReport extends ReportGenerator{
    ...
    protected List<SheetTask> getSheetTasks(String projectId, Range range) {
        ...
        SheetTask projectTask = new SheetTask("全部科目", SchoolPassCompareSheets.class);
        ...
        for (Target subject : subjects) {
            ...
            projectTask = new SheetTask(subjectName, SchoolPassCompareSheets.class);
